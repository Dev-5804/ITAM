        ...
        <Card className="border-zinc-200/60 dark:border-zinc-800/60 shadow-xl shadow-zinc-900/5 backdrop-blur-sm bg-white/80 dark:bg-zinc-950/80">
            ...
            <CardContent>
                <div className="space-y-4">
                    ...
                    <Button
                        variant="outline"
                        className="w-full py-5 font-medium transition-all hover:bg-zinc-100 dark:hover:bg-zinc-900 border-zinc-200 dark:border-zinc-800"
                        type="button"
            ...
            <CardFooter className="flex flex-col gap-4 text-center">
                <div className="text-sm text-zinc-500 dark:text-zinc-400">
                    New to ITAM?{" "}
                    <Link href="/signup" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 font-medium hover:underline transition-colors">
                        Create an account
                    </Link>
                </div>
            </CardFooter>
